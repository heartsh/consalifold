...
def main():
  ...
  for gamma in gammas:
    ...
    for rna_fam_file in os.listdir(rna_fam_dir_path):
      ...
      posterior_probcons_plus_consalifold_estimated_css_file_path = os.path.join(posterior_probcons_plus_consalifold_estimated_css_dir_path, "hyperparam=" + gamma_str + ".sth")
      ...
      posterior_clustalw_plus_consalifold_estimated_css_file_path = os.path.join(posterior_clustalw_plus_consalifold_estimated_css_dir_path, "hyperparam=" + gamma_str + ".sth")
      ...
      posterior_mafft_plus_consalifold_estimated_css_file_path = os.path.join(posterior_mafft_plus_consalifold_estimated_css_dir_path, "hyperparam=" + gamma_str + ".sth")
      ...
      posterior_mafft_xinsi_plus_consalifold_estimated_css_file_path = os.path.join(posterior_mafft_xinsi_plus_consalifold_estimated_css_dir_path, "hyperparam=" + gamma_str + ".sth")
      ...
      posterior_ref_sa_plus_consalifold_estimated_css_file_path = os.path.join(posterior_ref_sa_plus_consalifold_estimated_css_dir_path, "hyperparam=" + gamma_str + ".sth")
