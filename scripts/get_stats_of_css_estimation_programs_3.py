...
def main():
  ...
  pyplot.figure()
  line_1, = pyplot.plot(-2., locarna_f1_score, label = "LocARNA", marker = "o", linestyle = "-")
  line_2, = pyplot.plot(-2., raf_f1_score, label = "RAF", marker = "v", linestyle = "--")
  ...
  pyplot.clf()
  pyplot.figure()
  line_1, = pyplot.plot(-2., locarna_mcc, label = "LocARNA", marker = "o", linestyle = "-")
  line_2, = pyplot.plot(-2., raf_mcc, label = "RAF", marker = "v", linestyle = "--")
