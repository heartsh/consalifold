...
def main():
  ...
  mafft_plus_petfold_ppv = mafft_plus_petfold_sens = mafft_plus_petfold_fpr = mafft_plus_petfold_f1_score = mafft_plus_petfold_mcc = 0.
  probcons_plus_petfold_ppv = probcons_plus_petfold_sens = probcons_plus_petfold_fpr = probcons_plus_petfold_f1_score = probcons_plus_petfold_mcc = 0.
  clustalw_plus_petfold_ppv = clustalw_plus_petfold_sens = clustalw_plus_petfold_fpr = clustalw_plus_petfold_f1_score = clustalw_plus_petfold_mcc = 0.
  ...
  for gamma in gammas:
    ...
    mafft_plus_consalifold_f1_scores.append(get_f1_score(ppv, sens))
    mafft_plus_consalifold_mccs.append(get_mcc(mafft_plus_consalifold_tp, mafft_plus_consalifold_tn, mafft_plus_consalifold_fp, mafft_plus_consalifold_fn))
    ...
    probcons_plus_consalifold_f1_scores.append(get_f1_score(ppv, sens))
    probcons_plus_consalifold_mccs.append(get_mcc(probcons_plus_consalifold_tp, probcons_plus_consalifold_tn, probcons_plus_consalifold_fp, probcons_plus_consalifold_fn))
    ...
    clustalw_plus_consalifold_f1_scores.append(get_f1_score(ppv, sens))
    clustalw_plus_consalifold_mccs.append(get_mcc(clustalw_plus_consalifold_tp, clustalw_plus_consalifold_tn, clustalw_plus_consalifold_fp, clustalw_plus_consalifold_fn))
    ...
    mafft_plus_centroidalifold_f1_scores.append(get_f1_score(ppv, sens))
    mafft_plus_centroidalifold_mccs.append(get_mcc(mafft_plus_centroidalifold_tp, mafft_plus_centroidalifold_tn, mafft_plus_centroidalifold_fp, mafft_plus_centroidalifold_fn))
    ...
    probcons_plus_centroidalifold_f1_scores.append(get_f1_score(ppv, sens))
    probcons_plus_centroidalifold_mccs.append(get_mcc(probcons_plus_centroidalifold_tp, probcons_plus_centroidalifold_tn, mafft_plus_centroidalifold_fp, probcons_plus_centroidalifold_fn))
    ...
    clustalw_plus_centroidalifold_f1_scores.append(get_f1_score(ppv, sens))
    clustalw_plus_centroidalifold_mccs.append(get_mcc(clustalw_plus_centroidalifold_tp, clustalw_plus_centroidalifold_tn, clustalw_plus_centroidalifold_fp, clustalw_plus_centroidalifold_fn))
    if gamma == 1.:
    ...
    if gamma == 1.:
      ...
      probcons_plus_petfold_f1_score = get_f1_score(probcons_plus_petfold_ppv, probcons_plus_petfold_sens)
  ...
  line_7, = pyplot.plot(-3., mafft_plus_rnaalifold_f1_score, label = "MAFFT + RNAAlifold", marker = "v", linestyle = "-")
  line_8, = pyplot.plot(-4., probcons_plus_rnaalifold_f1_score, label = "ProbCons + RNAAlifold", marker = "v", linestyle = "--")
  line_9, = pyplot.plot(-5., clustalw_plus_rnaalifold_f1_score, label = "ClustalW + RNAAlifold", marker = "v", linestyle = ":")
  line_10, = pyplot.plot(-3., mafft_plus_petfold_f1_score, label = "MAFFT + PETfold", marker = "^", linestyle = "-")
  line_11, = pyplot.plot(-4., probcons_plus_petfold_f1_score, label = "ProbCons + PETfold", marker = "^", linestyle = "--")
  line_12, = pyplot.plot(-5., clustalw_plus_petfold_f1_score, label = "ClustalW + PETfold", marker = "^", linestyle = ":")
  ...
  line_7, = pyplot.plot(-3., mafft_plus_rnaalifold_f1_score, label = "MAFFT + RNAAlifold", marker = "v", linestyle = "-")
  line_8, = pyplot.plot(-4., probcons_plus_rnaalifold_mcc, label = "ProbCons + RNAAlifold", marker = "v", linestyle = "--")
  line_9, = pyplot.plot(-5., clustalw_plus_rnaalifold_mcc, label = "ClustalW + RNAAlifold", marker = "v", linestyle = ":")
  line_10, = pyplot.plot(-3., mafft_plus_petfold_mcc, label = "MAFFT + PETfold", marker = "^", linestyle = "-")
  line_11, = pyplot.plot(-4., probcons_plus_petfold_mcc, label = "ProbCons + PETfold", marker = "^", linestyle = "--")
  line_12, = pyplot.plot(-5., clustalw_plus_petfold_mcc, label = "ClustalW + PETfold", marker = "^", linestyle = ":")
  pyplot.xlabel("$\log_2 \gamma$")
  pyplot.ylabel("MCC")
  pyplot.tight_layout()
